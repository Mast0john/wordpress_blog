...
<h1>
<?php if ( is_day() ) : ?>
<?php printf( __( 'Daily Archives: %s', 'mytheme' ), '<span>' . get_the_date() . '</span>' ); ?>
<?php elseif ( is_month() ) : ?>
<?php printf( __( 'Monthly Archives: %s', 'mytheme' ), '<span>' . get_the_date( 'F Y' ) . '</span>' ); ?>
<?php elseif ( is_year() ) : ?>
<?php printf( __( 'Yearly Archives: %s', 'mytheme' ), '<span>' . get_the_date( 'Y' ) . '</span>' ); ?>
<?php else : ?>
