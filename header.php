...
<![endif]-->
<style>
<?php $var = Template_theme_option('ttr_avatar_size');
if(!empty($var)){ 
?>
.ttr_comment_author{width : <?php echo Template_theme_option('ttr_avatar_size')."px";?>;}
<?php 
$avtar = $var + 10;
} else {
$avtar = 10;
...
<?php if (Template_theme_option('ttr_back_to_top')): ?>
<?php $gotopng = Template_theme_option('ttr_icon_back_to_top');?>
<div class="totopshow">
<?php if(!empty($gotopng)): ?>
<a href="#" class="back-to-top">
<img alt="<?php esc_attr_e('Back to Top', 'mytheme'); ?>" src="<?php echo esc_url($gotopng); ?>">
</a>
<?php else : ?>
<a href="#" class="back-to-top">
<img alt="<?php esc_attr_e('Back to Top', 'mytheme'); ?>" src="<?php echo esc_url(get_template_directory_uri()).'/images/gototop0.png';?>">
</a>
<?php endif; ?>
</div>
...
<?php Template_theme_dynamic_sidebar( 'HAWidgetArea00'); ?>
</div>
...
<?php Template_theme_dynamic_sidebar( 'HAWidgetArea01'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'HAWidgetArea02'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'HAWidgetArea03'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<div class="html_content"><p><span>Call us at : 03 21 56 84 78</span></p></div>
</div>
<?php if (Template_theme_option ("ttr_header_logo_enable")):?>
<div class="ttr_header_logo">
<a class="logo" href="<?php echo Template_theme_option('ttr_logo_link')?>" target="_self">
<?php
...
<?php Template_theme_dynamic_sidebar( 'HBWidgetArea00'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'HBWidgetArea01'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'HBWidgetArea02'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'HBWidgetArea03'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MAWidgetArea00'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MAWidgetArea01'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MAWidgetArea02'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MAWidgetArea03'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MBWidgetArea00'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MBWidgetArea01'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MBWidgetArea02'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php Template_theme_dynamic_sidebar( 'MBWidgetArea03'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
